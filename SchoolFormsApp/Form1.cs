...
namespace SchoolFormsApp
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var student = new Student(); //for testing only - remove later
        ...
        private void btnTestTeacher_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("The teacher's grade point average is " + gp);
        }
        ...
        private void btnTestStudent_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("The studnet's grade point average is " + gp);
        }
    }
}
